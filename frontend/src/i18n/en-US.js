export default {
  ...
  dsView: {
    ...
    dragPreviewUpdated: 'Preview updated (not saved to the database). Save plan to persist or discard to revert.',
    invalidResourceTarget: 'Target resource is not in the same work center as the routing; cannot drop on that resource row',
    resourceUnavailable: 'Resource unavailable',
    cannotBeforePrevOperation: 'Cannot start before previous operation ends',
    saveOrDiscardFirst: 'Please save or discard current plan before adjusting',
